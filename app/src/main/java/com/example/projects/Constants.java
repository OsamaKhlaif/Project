...
public class Constants {
    ...
    public static final String TODOS_CHILD_ACTIVITY = "TodoChildActivity";
    public static final String BASE_URL = "https://ed16-185-114-120-44.ngrok.io";
    ...
    public static final String ON_NEXT = "--Success--";
